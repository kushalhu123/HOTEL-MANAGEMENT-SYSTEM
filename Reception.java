...
public class Reception extends JFrame {
	...
	public Reception(){
		...
		contentPane.add(btnManagerInfo);
                ...
                JButton btnFoodInfo = new JButton("Food Info");
		btnFoodInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
				FoodInfo  fo = new FoodInfo();
				fo.setVisible(true);
                                setVisible(false);
				}
				catch (Exception e1){
		...
		btnFoodInfo.setBounds(10, 270, 200, 30);
                btnFoodInfo.setBackground(Color.BLACK);
                btnFoodInfo.setForeground(Color.WHITE);

		contentPane.add(btnFoodInfo);
		...
		btnNewButton_4.setBounds(10, 310, 200, 30);
		...
		btnPickUpSerice.setBounds(10, 430, 200, 30);
		...
		btnNewButton_8.setBounds(10, 550, 200, 30);
