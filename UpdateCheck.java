...
public class UpdateCheck extends JFrame {
	...
	public UpdateCheck() throws SQLException {
		...
		contentPane.add(lblUpdateCheckStatus);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/checkin.jpg"));
		...
		contentPane.add(txt_ID);
                ...
                JLabel f1= new JLabel("Food ID :");
		f1.setBounds(25, 174, 107, 14);
		contentPane.add(f1);
                
                txt_Food = new JTextField();
                txt_Food.setBounds(248, 171, 140, 20);
		contentPane.add(txt_Food);
                
                
		
		JLabel lblNewLabel_2 = new JLabel("Name : ");
		lblNewLabel_2.setBounds(25, 216, 97, 14);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Checked-in :");
		lblNewLabel_3.setBounds(25, 261, 107, 14);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("Amount Paid (Rs) : ");
		lblNewLabel_4.setBounds(25, 302, 107, 14);
		contentPane.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("Pending Amount (Rs) : ");
		lblNewLabel_5.setBounds(25, 343, 150, 14);
		...
		txt_Date.setBounds(248, 258, 140, 20);
		contentPane.add(txt_Date);
		txt_Date.setColumns(10);
		
		txt_Time = new JTextField();
		txt_Time.setBounds(248, 299, 140, 20);
		contentPane.add(txt_Time);
		txt_Time.setColumns(10);
		
		txt_Payment = new JTextField();
		txt_Payment.setBounds(248, 340, 140, 20);
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) { 
				...
				String s2 = txt_ID.getText(); //room_number;
                                String s6=txt_Food.getText();//food_id
                                String s3 = txt_Status.getText(); //name    
                                String s4 = txt_Date.getText(); //status;    
                                String s5 = txt_Time.getText(); //deposit    
				
                                c.s.executeUpdate("update customer set room_number = '"+s2+"', foodid = '"+s6+"', name = '"+s3+"', status = '"+s4+"', deposit = '"+s5+"' where number = '"+s1+"'");
		...
		btnUpdate.setBounds(168, 410, 89, 23);
		...
		btnExit.setBounds(281, 410, 89, 23);
			...
			public void actionPerformed(ActionEvent e) {
				...
				conn c = new conn();
                                ...
                                while(rs1.next()){
                                    ...
                                    txt_Food.setText(rs1.getString("foodid"));
                            ...
                            try{
                                ...
                                while(rs2.next()){
                                    total1 = rs2.getString("price"); 
                                    
                                }
                                ResultSet rs3=c.s.executeQuery("select * from food where foodid ="+txt_Food.getText());
                                while(rs3.next()){
                                    total2=rs3.getString("foodcost");
                                }
                                totals=Integer.parseInt(total1)+Integer.parseInt(total2);
                                
                                
                                String paid = txt_Time.getText();
                                
                                int pending = totals- Integer.parseInt(paid);
                                txt_Payment.setText(Integer.toString(pending));
                                
                            }catch(Exception ee){}
			}
		});
		btnAdd.setBounds(56, 410, 89, 23);
