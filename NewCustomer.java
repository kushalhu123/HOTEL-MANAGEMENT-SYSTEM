...
public class NewCustomer extends JFrame {
	...
	private JTextField t1,t2,t3,t5,t6,t7;
        JComboBox comboBox;
        JRadioButton r1,r2;
        Choice c1,c2;
	/**
	...
	public NewCustomer() throws SQLException {
		...
		contentPane.add(lblGender);
                ...
                r1.setBounds(271, 191, 80, 11);
                add(r1);
                
                r2 = new JRadioButton("Female");
                r2.setFont(new Font("Raleway", Font.BOLD, 14));
                r2.setBackground(Color.WHITE);
                r2.setBounds(350, 191, 100, 11);
		add(r2);
		...
		contentPane.add(c1);
                ...
                JLabel lblReserveFoodNumber = new JLabel("Food/Meals");
		lblReserveFoodNumber.setBounds(35, 316, 200, 14);
		contentPane.add(lblReserveFoodNumber);
                
                c2=new Choice();
                try{
                    conn c = new conn();
                    ResultSet rs1 = c.s.executeQuery("select * from food");
                    while(rs1.next()){
                        c2.add(rs1.getString("foodid"));    
                    }
                }catch(Exception e){ }
                c2.setBounds(271, 317, 150, 20);
		contentPane.add(c2);
		...
		lblCheckInStatus.setBounds(35, 359, 200, 14);
